...
import { Calendar as CalendarIcon, MapPin, Loader2, Plane, Hotel, Utensils, Activity, Train, MoreHorizontal } from "lucide-react";
...
const eventSchema = z.object({
  ...
  cost: z.string().optional(), // Keeping as string for input, would parse to float in submit
});
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isLoading} className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white">
