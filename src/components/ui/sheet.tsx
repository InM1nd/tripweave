...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[0_4px_0_rgba(0,0,0,0.08)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out border-2 border-border",
  {
    variants: {
      side: {
